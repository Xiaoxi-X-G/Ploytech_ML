...
invokeBatchExecutionService = function() {
  ...
  api_key = "FJPD1F4RH6g6568EF/setcp8vy/69vUWOivv7iEeK/10Z5vU8pVWwKoVFoKbgRdYLg9y48ZYonEkD4dA9aXBqQ==" # Replace this with the API key for the web service
  url = "https://ussouthcentral.services.azureml.net/workspaces/0f1868dff67e488594ae34b2534e940f/services/cec081dda47546d1b83d2f11b7b14c16/jobs"
  
  authz_hdr = paste("Bearer", api_key, sep=" ")
  payload =  list(
  #  Outputs=list(
  #    ForecastingResults=list(ConnectionString=connection_string, RelativeLocation=paste("/", storage_container_name, "/ForecastingResultsresults.csv", sep=''))
  #  ),
